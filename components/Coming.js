...
<div>
    <h1 className='font-bold text-3xl text-orange text-center'>Dinner to Follow Ceremony</h1>
    <p className='text-primary text-center pt-2'>Please alert us if you have any allergies through the form below!</p>
